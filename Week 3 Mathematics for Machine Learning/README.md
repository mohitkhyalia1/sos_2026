...
Vectors, matrices, gradient descent, and statistics/probability - the math layer underneath the models studied from Week 4 Supervised Learning & Model Evaluation onward.
...
- A learning rate that's too high causes the cost to diverge instead of converge - same failure seen in the Week 4 Supervised Learning & Model Evaluation from-scratch Linear Regression notebook
- Mean vs median diverges on skewed data - the same check used for imputation decisions in Week 2 Data Preprocessing & EDA
...
- Standard deviation shows up in three places this week: variance formulas, the normal distribution's empirical rule, and StandardScaler's formula from Week 2 Data Preprocessing & EDA

---
*Week 3 Mathematics for Machine Learning - Mohit Khyalia, Summer of Science 2026, IIT Bombay*
