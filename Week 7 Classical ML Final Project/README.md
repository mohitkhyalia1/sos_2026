# Week 07 — Classical ML Final Project

Mohit Khyalia | Summer of Science 2026 | IIT Bombay

---

Week 7 establishes the strongest possible classical ML baseline on the Spaceship Titanic dataset. No EDA, no preprocessing — both are complete from Weeks 5–6. Week 7 is modelling, optimisation, and analysis only.
...
- **spaceship_titanic_submission.ipynb** — Best model fit on full labelled data, optimal threshold applied, Kaggle submission CSV generated, Week 7 experiment summary table presented. Sets up the comparison table that Week 8 completes.
...
- CryoSleep and IsSpender are the strongest features — validated by feature importances against the Week 5 EDA findings.
...
- The false positive / false negative breakdown by demographic group reveals which passenger types the model struggles with — informing potential additional feature engineering in Week 8.

---
*Week 07 — Mohit Khyalia, Summer of Science 2026, IIT Bombay*
